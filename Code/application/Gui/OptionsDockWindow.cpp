...
OptionsDockWindow::OptionsDockWindow() :
   QWidget(NULL),
   mpOpacity(NULL)
{
   ...
   mpOpacity->setValue(DockWindow::getSettingOpacity());
}
   
void OptionsDockWindow::applyChanges()
{  
   DockWindow::setSettingOpacity(mpOpacity->value());
}
