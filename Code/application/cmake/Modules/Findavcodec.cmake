...
if(avcodec_INCLUDE_DIR AND EXISTS "${avcodec_INCLUDE_DIR}/avcodec.h")
   ...
   if(avcodec_Parsed_Version)
      ...
      file(STRINGS "${avcodec_INCLUDE_DIR}/version.h" avcodec_Parsed_Version REGEX "^#define LIBAVCODEC_VERSION_MAJOR +.+$")
      string(REGEX REPLACE "^.*LIBAVCODEC_VERSION_MAJOR +" "" avcodec_VERSION_MAJOR "${avcodec_Parsed_Version}")
      file(STRINGS "${avcodec_INCLUDE_DIR}/version.h" avcodec_Parsed_Version REGEX "^#define LIBAVCODEC_VERSION_MINOR +.+$")
      string(REGEX REPLACE "^.*LIBAVCODEC_VERSION_MINOR +" "" avcodec_VERSION_MINOR "${avcodec_Parsed_Version}")
      file(STRINGS "${avcodec_INCLUDE_DIR}/version.h" avcodec_Parsed_Version REGEX "^#define LIBAVCODEC_VERSION_MICRO +.+$")
      string(REGEX REPLACE "^.*LIBAVCODEC_VERSION_MICRO +" "" avcodec_VERSION_PATCH "${avcodec_Parsed_Version}")
   endif()
